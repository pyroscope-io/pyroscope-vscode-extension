...
var mergeConfig = __webpack_require__(182);
...
axios.VERSION = (__webpack_require__(180).version);
...
var http = __webpack_require__(162);
var https = __webpack_require__(163);
var Writable = (__webpack_require__(166).Writable);
var assert = __webpack_require__(167);
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(169)("follow-redirects");
    }
    catch (error) { /* */ }
...
const tty = __webpack_require__(174);
const util = __webpack_require__(175);
...
try {
	...
	const supportsColor = __webpack_require__(176);
...
function activate(context) {
    ...
    let sideBarDisposable = vscode.commands.registerCommand('ts-vs-code-pyroscope.sideBar', (resource) => {
        console.log('sideBar!');
        vscode.window.showInformationMessage('Context menu thing triggered');
        console.dir(resource);
        vscode.workspace.openTextDocument(resource).then((a) => {
            // console.log('opened');
